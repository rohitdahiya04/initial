...
const projectImages = [
  `${process.env.PUBLIC_URL}/project/project1.jpg`,
  `${process.env.PUBLIC_URL}/project/project2.jpg`,
  `${process.env.PUBLIC_URL}/project/project3.jpg`,
  `${process.env.PUBLIC_URL}/project/project4.jpg`,
  `${process.env.PUBLIC_URL}/project/project5.jpg`
];
